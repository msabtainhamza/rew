...
const MoreFeatures = ({ propertyData }: any) => {
  ...
  return (
    <div className="mt-7 mb-10 pt-3 border-t border-t-[#DADADA]">
      ...
      >
        <p className="fw-semibold text-dark fs-20 font-abhaya">
          Interior Features
        </p>
        ...
        <div className="d-flex mt-3 gap-3 flex-wrap rounded-4 align-items-start bg-white justify-between">
          {featuresData.map((feature, index) => (
            ...
            >
              <p
                style={{ fontSize: "18px" }}
                className="fw-medium m-0 text-black d-flex align-items-center gap-1 font-abhaya"
              >
                <IoCheckmark className="text-black" /> {feature.label}
              </p>
              <p
                style={{ fontSize: "18px" }}
                className="text-black m-0 font-abhaya"
              >
                {feature.value}
              </p>
            </div>
