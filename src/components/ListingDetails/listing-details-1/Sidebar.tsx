...
const DateCarousel = ({
  ...
  return (
    <div className="flex items-center justify-center space-x-0 mt-10 mb-5 relative 2-full font-urbanist">
      <button
        onClick={handlePrev}
        className="bg-[#eeeefd] absolute top-[30%] left-1 z-[999] rounded-full w-[30px] h-[30px] flex justify-center items-center p-2 text-black"
      >
        &lt;
      </button>
      ...
      <button
        onClick={handleNext}
        className="bg-[#eeeefd] absolute top-[30%] right-1 z-[999] rounded-full w-[30px] h-[30px] flex justify-center items-center p-2 text-black"
      >
        &gt;
      </button>
    </div>
...
const Sidebar = () => {
  ...
  return (
    <div className="md:w-[28%] w-full md:mt-0 mt-9">
      <div className="">
        <div className="tour-schedule bg-white border-20 py-3 px-2  mb-20">
          ...
          <div className="flex justify-between items-center w-full my-4">
            {tabs.map((tab, index) => (
              <button
                ...
                } text-[16px] px-2 py-2 rounded-3xl h-[50px] w-[47%]`}
              >
                {tab.name}
              </button>
            ))}
              ...
              <button
                ...
                className={`${
                  activeTourType === tourType.value
                    ? "bg-[#6965fd] text-white"
                    : "text-black border border-[#D5D5D5]"
                } text-[16px] px-4 py-2 rounded-3xl h-[50px] w-[47%]`}
              >
                {tourType.name}
              </button>
            ))}
        ...
        <div className="mortgage-calculator bg-white border-20 p-30 mb-20">
