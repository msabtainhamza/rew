...
const Utilities = ({ propertyData }: any) => {
  ...
  return (
    <div className="mt-7 pt-3 border-t border-t-[#DADADA]">
      ...
      >
        <p className="fw-semibold text-dark fs-20 font-abhaya">Utilities</p>
          ...
          {utilityData.map((utility, index) => (
            ...
            >
              <p
                ...
                className="fw-medium m-0 text-[#5a5a5a] d-flex align-items-center gap-1 font-lato"
              >
                {utility.icon} {utility.label}
              </p>
              <p
                style={{ fontSize: utility.valueFontSize }}
                className="text-[#5a5a5a] m-0 font-lato"
              >
