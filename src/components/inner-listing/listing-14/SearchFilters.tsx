...
export default function SearchFilters() {
  ...
  return (
    <div className="w-full ">
      <div className="w-[94%] m-auto md:block hidden  px-4 py-3 bg-custom-theme">
        <div className="w-full bg-white md:flex justify-between md:px-3 px-1 py-4 items-center">
            ...
            {searchOptions.map((option, index) => (
              ...
              >
                ...
                <div
                  ...
                  className="flex justify-between items-center text-[18px]  text-black font-[400] font-lato"
                >
