...
const PropertySliderForRent = () => {
   ...
   return (
      <div className="property-listing-one   xl-mt-120  xl-pt-120 lg-pt-80 pb-180 xl-pb-120 lg-pb-100">
         <div className="container">
            <div className="position-relative">
               <div className="title-one text-center text-lg-start mb-45 xl-mb-30 lg-mb-20 wow fadeInUp">
                  <h3>New <span>Listings For Sale Properties</span></h3>
                
               </div>
               

               <Slider {...settings} ref={sliderRef} className="property-slider">
                  {property_data.filter((items) => items.page === "home_1" && items.tag === "FOR RENT").map((item) => (
...
export default PropertySliderForRent;
