...
export default function Hero() {
  return (
    <div className="flex justify-center flex-col items-center  text-center">
      <h1 className="md:text-[75px] text-[30px] font-urbanist text-black font-bold">
      ...
      <div className=" mt-7 px-3 md:w-[651px] w-[320px] md:h-[70px] h-[68px] flex justify-between items-center rounded-[50px] bg-white shadow-lg">
        ...
        />
        <div className="bg-black md:w-[70px] w-[41] md:h-[47px] h-[41] rounded-[50px] flex justify-center items-center">
