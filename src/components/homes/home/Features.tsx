...
export default function Features() {
  return (
    <div className="w-full mt-11 mb-11  mx-auto md:flex justify-between items-center ">
      <div className="md:block hidden w-[27%]">
        {mockData.slice(0, 4).map((item, index) => (
          <div key={index} className="flex gap-4 justify-end items-center mb-3">
            ...
            <div className="w-[50%] text-[25px] font-semibold font-urbanist text-black">
              {item.label}
            </div>
          </div>
        ))}
      ...
      <div className="md:block hidden w-[27%]">
        {mockData.slice(4).map((item, index) => (
          ...
          >
            ...
            <div className="text-[25px] w-[50%] font-semibold font-urbanist text-black">
              {item.label}
            </div>
          </div>
        ))}
