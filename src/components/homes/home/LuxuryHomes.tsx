...
const Card = ({ item }: { item: any }) => {
  return (
    <div className="md:w-[369.93px] w-[330px] h-[424.52px] rounded-[20px] shadow-md relative group">
      ...
      <div className="absolute inset-0 hidden group-hover:flex bg-[#e6e6e6] text-white px-2 rounded-[20px] justify-center items-center font-urbanist">
